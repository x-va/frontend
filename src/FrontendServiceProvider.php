...
class FrontendServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            $this->publishes([
                __DIR__.'/../config/x-va-frontend.php' => config_path('x-va-frontend.php'),
            ], 'config');
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../config/x-va-frontend.php', 'x-va-frontend');
    }
}
